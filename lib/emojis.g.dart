// Generated code. Do not modify. Generated at 2025-04-16 11:48:35.394215.
...
class AnimatedEmojis {
  ...
  static const smile = AnimatedEmojiData(
    '1f600',
    name: 'smile',
  ...
  static const smileWithBigEyes = AnimatedEmojiData(
    '1f603',
    name: 'smileWithBigEyes',
    categories: ['Smileys and emotions'],
  ...
  static const grin = AnimatedEmojiData(
    '1f604',
    name: 'grin',
    categories: ['Smileys and emotions'],
    tags: [':grin:'],
  ...
  static const grinning = AnimatedEmojiData(
    '1f601',
    name: 'grinning',
    categories: ['Smileys and emotions'],
    tags: [':grinning:'],
  ...
  static const laughing = AnimatedEmojiData(
    '1f606',
    name: 'laughing',
    categories: ['Smileys and emotions'],
    tags: [':laughing:'],
  ...
  static const grinSweat = AnimatedEmojiData(
    '1f605',
    name: 'grinSweat',
    categories: ['Smileys and emotions'],
    tags: [':grin-sweat:'],
  ...
  static const joy = AnimatedEmojiData(
    '1f602',
    name: 'joy',
    categories: ['Smileys and emotions'],
    tags: [':joy:'],
  ...
  static const rofl = AnimatedEmojiData(
    '1f923',
    name: 'rofl',
    categories: ['Smileys and emotions'],
    tags: [':rofl:'],
  ...
  static const loudlyCrying = AnimatedEmojiData(
    '1f62d',
    name: 'loudlyCrying',
    categories: ['Smileys and emotions'],
    tags: [':loudly-crying:'],
  ...
  static const wink = AnimatedEmojiData(
    '1f609',
    name: 'wink',
    categories: ['Smileys and emotions'],
    tags: [':wink:'],
  ...
  static const kissing = AnimatedEmojiData(
    '1f617',
    name: 'kissing',
    categories: ['Smileys and emotions'],
    tags: [':kissing:'],
  ...
  static const kissingSmilingEyes = AnimatedEmojiData(
    '1f619',
    name: 'kissingSmilingEyes',
    categories: ['Smileys and emotions'],
  ...
  static const kissingClosedEyes = AnimatedEmojiData(
    '1f61a',
    name: 'kissingClosedEyes',
    categories: ['Smileys and emotions'],
  ...
  static const kissingHeart = AnimatedEmojiData(
    '1f618',
    name: 'kissingHeart',
    categories: ['Smileys and emotions'],
    tags: [':kissing-heart:'],
  ...
  static const heartFace = AnimatedEmojiData(
    '1f970',
    name: 'heartFace',
    categories: ['Smileys and emotions'],
  ...
  static const heartEyes = AnimatedEmojiData(
    '1f60d',
    name: 'heartEyes',
    categories: ['Smileys and emotions'],
    tags: [':heart-eyes:'],
  ...
  static const starStruck = AnimatedEmojiData(
    '1f929',
    name: 'starStruck',
    categories: ['Smileys and emotions'],
    tags: [':star-struck:'],
  ...
  static const partyingFace = AnimatedEmojiData(
    '1f973',
    name: 'partyingFace',
    categories: ['Smileys and emotions'],
    tags: [':partying-face:'],
  ...
  static const melting = AnimatedEmojiData(
    '1fae0',
    name: 'melting',
    categories: ['Smileys and emotions'],
    tags: [':melting:'],
  ...
  static const upsideDownFace = AnimatedEmojiData(
    '1f643',
    name: 'upsideDownFace',
    categories: ['Smileys and emotions'],
  ...
  static const slightlyHappy = AnimatedEmojiData(
    '1f642',
    name: 'slightlyHappy',
    categories: ['Smileys and emotions'],
    tags: [':slightly-happy:'],
  ...
  static const happyCry = AnimatedEmojiData(
    '1f972',
    name: 'happyCry',
    categories: ['Smileys and emotions'],
    tags: [':happy-cry:'],
  ...
  static const holdingBackTears = AnimatedEmojiData(
    '1f979',
    name: 'holdingBackTears',
    categories: ['Smileys and emotions'],
  ...
  static const blush = AnimatedEmojiData(
    '1f60a',
    name: 'blush',
    categories: ['Smileys and emotions'],
    tags: [':blush:'],
  ...
  static const warmSmile = AnimatedEmojiData(
    '263a_fe0f',
    name: 'warmSmile',
    categories: ['Smileys and emotions'],
    tags: [':warm-smile:'],
  ...
  static const relieved = AnimatedEmojiData(
    '1f60c',
    name: 'relieved',
    categories: ['Smileys and emotions'],
    tags: [':relieved:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f642_200d_2195_fe0f/512.gif" alt="headNod" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of headNod.
  static const headNod = AnimatedEmojiData(
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f642_200d_2194_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f642_200d_2194_fe0f/512.gif" alt="headShake" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of headShake.
  static const headShake = AnimatedEmojiData(
  ...
  static const smirk = AnimatedEmojiData(
    '1f60f',
    name: 'smirk',
    categories: ['Smileys and emotions'],
    tags: [':smirk:'],
  ...
  static const drool = AnimatedEmojiData(
    '1f924',
    name: 'drool',
    categories: ['Smileys and emotions'],
    tags: [':drool:'],
  ...
  static const yum = AnimatedEmojiData(
    '1f60b',
    name: 'yum',
    categories: ['Smileys and emotions'],
    tags: [':yum:'],
  ...
  static const stuckOutTongue = AnimatedEmojiData(
    '1f61b',
    name: 'stuckOutTongue',
    categories: ['Smileys and emotions'],
  ...
  static const squintingTongue = AnimatedEmojiData(
    '1f61d',
    name: 'squintingTongue',
    categories: ['Smileys and emotions'],
  ...
  static const winkyTongue = AnimatedEmojiData(
    '1f61c',
    name: 'winkyTongue',
    categories: ['Smileys and emotions'],
    tags: [':winky-tongue:'],
  ...
  static const zanyFace = AnimatedEmojiData(
    '1f92a',
    name: 'zanyFace',
    categories: ['Smileys and emotions'],
    tags: [':zany-face:'],
  ...
  static const woozy = AnimatedEmojiData(
    '1f974',
    name: 'woozy',
    categories: ['Smileys and emotions'],
    tags: [':woozy:'],
  ...
  static const pensive = AnimatedEmojiData(
    '1f614',
    name: 'pensive',
    categories: ['Smileys and emotions'],
    tags: [':pensive:'],
  ...
  static const pleading = AnimatedEmojiData(
    '1f97a',
    name: 'pleading',
    categories: ['Smileys and emotions'],
    tags: [':pleading:'],
  ...
  static const grimacing = AnimatedEmojiData(
    '1f62c',
    name: 'grimacing',
    categories: ['Smileys and emotions'],
    tags: [':grimacing:'],
  ...
  static const expressionless = AnimatedEmojiData(
    '1f611',
    name: 'expressionless',
    categories: ['Smileys and emotions'],
    tags: [':expressionless:'],
  ...
  static const neutralFace = AnimatedEmojiData(
    '1f610',
    name: 'neutralFace',
    categories: ['Smileys and emotions'],
    tags: [':neutral-face:'],
  ...
  static const mouthNone = AnimatedEmojiData(
    '1f636',
    name: 'mouthNone',
    categories: ['Smileys and emotions'],
    tags: [':mouth-none:'],
  ...
  static const faceInClouds = AnimatedEmojiData(
  ...
  static const dottedLineFace = AnimatedEmojiData(
    '1fae5',
    name: 'dottedLineFace',
    categories: ['Smileys and emotions'],
  ...
  static const zipperFace = AnimatedEmojiData(
    '1f910',
    name: 'zipperFace',
    categories: ['Smileys and emotions'],
    tags: [':zipper-face:'],
  ...
  static const salute = AnimatedEmojiData(
    '1fae1',
    name: 'salute',
    categories: ['Smileys and emotions'],
    tags: [':salute:'],
  ...
  static const thinkingFace = AnimatedEmojiData(
    '1f914',
    name: 'thinkingFace',
    categories: ['Smileys and emotions'],
    tags: [':thinking-face:'],
  ...
  static const shushingFace = AnimatedEmojiData(
    '1f92b',
    name: 'shushingFace',
    categories: ['Smileys and emotions'],
    tags: [':shushing-face:'],
  ...
  static const handOverMouth = AnimatedEmojiData(
    '1fae2',
    name: 'handOverMouth',
    categories: ['Smileys and emotions'],
  ...
  static const smilingEyesWithHandOverMouth = AnimatedEmojiData(
    '1f92d',
    name: 'smilingEyesWithHandOverMouth',
    categories: ['Smileys and emotions'],
  ...
  static const yawn = AnimatedEmojiData(
    '1f971',
    name: 'yawn',
    categories: ['Smileys and emotions'],
    tags: [':yawn:'],
  ...
  static const hugFace = AnimatedEmojiData(
    '1f917',
    name: 'hugFace',
    categories: ['Smileys and emotions'],
    tags: [':hug-face:'],
  ...
  static const peeking = AnimatedEmojiData(
    '1fae3',
    name: 'peeking',
    categories: ['Smileys and emotions'],
    tags: [':peeking:'],
  ...
  static const screaming = AnimatedEmojiData(
    '1f631',
    name: 'screaming',
    categories: ['Smileys and emotions'],
    tags: [':screaming:'],
  ...
  static const raisedEyebrow = AnimatedEmojiData(
    '1f928',
    name: 'raisedEyebrow',
    categories: ['Smileys and emotions'],
    tags: [':raised-eyebrow:'],
  ...
  static const monocle = AnimatedEmojiData(
    '1f9d0',
    name: 'monocle',
    categories: ['Smileys and emotions'],
    tags: [':monocle:'],
  ...
  static const unamused = AnimatedEmojiData(
    '1f612',
    name: 'unamused',
    categories: ['Smileys and emotions'],
    tags: [':unamused:'],
  ...
  static const rollingEyes = AnimatedEmojiData(
    '1f644',
    name: 'rollingEyes',
    categories: ['Smileys and emotions'],
    tags: [':rolling-eyes:'],
  ...
  static const exhale = AnimatedEmojiData(
    '1f62e_200d_1f4a8',
    name: 'exhale',
    categories: ['Smileys and emotions'],
    tags: [':exhale:'],
  ...
  static const triumph = AnimatedEmojiData(
    '1f624',
    name: 'triumph',
    categories: ['Smileys and emotions'],
    tags: [':triumph:'],
  ...
  static const angry = AnimatedEmojiData(
    '1f620',
    name: 'angry',
    categories: ['Smileys and emotions'],
    tags: [':angry:'],
  ...
  static const rage = AnimatedEmojiData(
    '1f621',
    name: 'rage',
    categories: ['Smileys and emotions'],
    tags: [':rage:'],
  ...
  static const cursing = AnimatedEmojiData(
    '1f92c',
    name: 'cursing',
    categories: ['Smileys and emotions'],
    tags: [':cursing:'],
  ...
  static const sad = AnimatedEmojiData(
    '1f61e',
    name: 'sad',
    categories: ['Smileys and emotions'],
    tags: [':sad:'],
  ...
  static const sweat = AnimatedEmojiData(
    '1f613',
    name: 'sweat',
    categories: ['Smileys and emotions'],
    tags: [':sweat:', ':downcast:'],
  ...
  static const worried = AnimatedEmojiData(
    '1f61f',
    name: 'worried',
    categories: ['Smileys and emotions'],
    tags: [':worried:'],
  ...
  static const concerned = AnimatedEmojiData(
    '1f625',
    name: 'concerned',
    categories: ['Smileys and emotions'],
    tags: [':concerned:'],
  ...
  static const cry = AnimatedEmojiData(
    '1f622',
    name: 'cry',
    categories: ['Smileys and emotions'],
    tags: [':cry:'],
  ...
  static const bigFrown = AnimatedEmojiData(
    '2639_fe0f',
    name: 'bigFrown',
    categories: ['Smileys and emotions'],
    tags: [':big-frown:'],
  ...
  static const frown = AnimatedEmojiData(
    '1f641',
    name: 'frown',
    categories: ['Smileys and emotions'],
    tags: [':frown:'],
  ...
  static const diagonalMouth = AnimatedEmojiData(
    '1fae4',
    name: 'diagonalMouth',
    categories: ['Smileys and emotions'],
    tags: [':diagonal-mouth:'],
  ...
  static const slightlyFrowning = AnimatedEmojiData(
    '1f615',
    name: 'slightlyFrowning',
    categories: ['Smileys and emotions'],
  ...
  static const anxiousWithSweat = AnimatedEmojiData(
    '1f630',
    name: 'anxiousWithSweat',
    categories: ['Smileys and emotions'],
  ...
  static const scared = AnimatedEmojiData(
    '1f628',
    name: 'scared',
    categories: ['Smileys and emotions'],
    tags: [':scared:'],
  ...
  static const anguished = AnimatedEmojiData(
    '1f627',
    name: 'anguished',
    categories: ['Smileys and emotions'],
    tags: [':anguished:'],
  ...
  static const gasp = AnimatedEmojiData(
    '1f626',
    name: 'gasp',
    categories: ['Smileys and emotions'],
    tags: [':gasp:'],
  ...
  static const mouthOpen = AnimatedEmojiData(
    '1f62e',
    name: 'mouthOpen',
    categories: ['Smileys and emotions'],
    tags: [':mouth-open:'],
  ...
  static const surprised = AnimatedEmojiData(
    '1f62f',
    name: 'surprised',
    categories: ['Smileys and emotions'],
  ...
  static const astonished = AnimatedEmojiData(
    '1f632',
    name: 'astonished',
    categories: ['Smileys and emotions'],
    tags: [':astonished:'],
  ...
  static const flushed = AnimatedEmojiData(
    '1f633',
    name: 'flushed',
    categories: ['Smileys and emotions'],
    tags: [':flushed:'],
  ...
  static const mindBlown = AnimatedEmojiData(
    '1f92f',
    name: 'mindBlown',
    categories: ['Smileys and emotions'],
  ...
  static const scrunchedMouth = AnimatedEmojiData(
    '1f616',
    name: 'scrunchedMouth',
    categories: ['Smileys and emotions'],
  ...
  static const scrunchedEyes = AnimatedEmojiData(
    '1f623',
    name: 'scrunchedEyes',
    categories: ['Smileys and emotions'],
  ...
  static const weary = AnimatedEmojiData(
    '1f629',
    name: 'weary',
    categories: ['Smileys and emotions'],
    tags: [':weary:'],
  ...
  static const distraught = AnimatedEmojiData(
    '1f62b',
    name: 'distraught',
    categories: ['Smileys and emotions'],
    tags: [':distraught:'],
  ...
  static const xEyes = AnimatedEmojiData(
    '1f635',
    name: 'xEyes',
    categories: ['Smileys and emotions'],
    tags: [':x-eyes:'],
  ...
  static const dizzyFace = AnimatedEmojiData(
    '1f635_200d_1f4ab',
    name: 'dizzyFace',
    categories: ['Smileys and emotions'],
    tags: [':dizzy-face:'],
  ...
  static const shakingFace = AnimatedEmojiData(
    '1fae8',
    name: 'shakingFace',
    categories: ['Smileys and emotions'],
    tags: [':shaking-face:'],
  ...
  static const coldFace = AnimatedEmojiData(
    '1f976',
    name: 'coldFace',
    categories: ['Smileys and emotions'],
    tags: [':cold-face:'],
  ...
  static const hotFace = AnimatedEmojiData(
    '1f975',
    name: 'hotFace',
    categories: ['Smileys and emotions'],
  ...
  static const sick = AnimatedEmojiData(
    '1f922',
    name: 'sick',
    categories: ['Smileys and emotions'],
    tags: [':sick:', ':nauseated:'],
  ...
  static const vomit = AnimatedEmojiData(
    '1f92e',
    name: 'vomit',
    categories: ['Smileys and emotions'],
    tags: [':vomit:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fae9/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fae9/512.gif" alt="tired" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of tired.
  static const tired = AnimatedEmojiData(
    '1fae9',
    name: 'tired',
    categories: ['Smileys and emotions'],
  ...
  static const sleep = AnimatedEmojiData(
    '1f634',
    name: 'sleep',
    categories: ['Smileys and emotions'],
    tags: [':sleep:'],
  ...
  static const sleepy = AnimatedEmojiData(
    '1f62a',
    name: 'sleepy',
    categories: ['Smileys and emotions'],
    tags: [':sleepy:'],
  ...
  static const sneeze = AnimatedEmojiData(
    '1f927',
    name: 'sneeze',
    categories: ['Smileys and emotions'],
    tags: [':sneeze:'],
  ...
  static const thermometerFace = AnimatedEmojiData(
    '1f912',
    name: 'thermometerFace',
    categories: ['Smileys and emotions'],
  ...
  static const bandageFace = AnimatedEmojiData(
    '1f915',
    name: 'bandageFace',
    categories: ['Smileys and emotions'],
    tags: [':bandage-face:'],
  ...
  static const mask = AnimatedEmojiData(
    '1f637',
    name: 'mask',
    categories: ['Smileys and emotions'],
    tags: [':mask:'],
  ...
  static const liar = AnimatedEmojiData(
    '1f925',
    name: 'liar',
    categories: ['Smileys and emotions'],
    tags: [':liar:'],
  ...
  static const halo = AnimatedEmojiData(
    '1f607',
    name: 'halo',
    categories: ['Smileys and emotions'],
    tags: [':halo:', ':innocent:'],
  ...
  static const cowboy = AnimatedEmojiData(
    '1f920',
    name: 'cowboy',
    categories: ['Smileys and emotions'],
    tags: [':cowboy:'],
  ...
  static const moneyFace = AnimatedEmojiData(
    '1f911',
    name: 'moneyFace',
    categories: ['Smileys and emotions'],
    tags: [':money-face:'],
  ...
  static const nerdFace = AnimatedEmojiData(
    '1f913',
    name: 'nerdFace',
    categories: ['Smileys and emotions'],
    tags: [':nerd-face:'],
  ...
  static const sunglassesFace = AnimatedEmojiData(
    '1f60e',
    name: 'sunglassesFace',
    categories: ['Smileys and emotions'],
  ...
  static const disguise = AnimatedEmojiData(
    '1f978',
    name: 'disguise',
    categories: ['Smileys and emotions'],
    tags: [':disguise:'],
  ...
  static const clown = AnimatedEmojiData(
    '1f921',
    name: 'clown',
    categories: ['Smileys and emotions'],
    tags: [':clown:'],
  ...
  static const poop = AnimatedEmojiData(
    '1f4a9',
    name: 'poop',
    categories: ['Smileys and emotions'],
    tags: [':poop:'],
  ...
  static const impSmile = AnimatedEmojiData(
    '1f608',
    name: 'impSmile',
    categories: ['Smileys and emotions'],
    tags: [':imp-smile:'],
  ...
  static const impFrown = AnimatedEmojiData(
    '1f47f',
    name: 'impFrown',
    categories: ['Smileys and emotions'],
    tags: [':imp-frown:'],
  ...
  static const skull = AnimatedEmojiData(
    '1f480',
    name: 'skull',
    categories: ['Smileys and emotions'],
    tags: [':skull:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/2603_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/2603_fe0f/512.gif" alt="snowmanWithSnow" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of snowmanWithSnow.
  static const snowmanWithSnow = AnimatedEmojiData(
    '2603_fe0f',
    name: 'snowmanWithSnow',
    categories: ['Smileys and emotions'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26c4/512.gif" alt="snowman" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of snowman.
  static const snowman = AnimatedEmojiData(
    '26c4',
    name: 'snowman',
    categories: ['Smileys and emotions'],
    tags: [':snowman:'],
  ...
  static const jackOLantern = AnimatedEmojiData(
    '1f383',
    name: 'jackOLantern',
    categories: ['Smileys and emotions'],
    tags: [':jack-o-lantern:'],
  ...
  static const alien = AnimatedEmojiData(
    '1f47d',
    name: 'alien',
    categories: ['Smileys and emotions'],
    tags: [':alien:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f47e/512.gif" alt="alienMonster" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of alienMonster.
  static const alienMonster = AnimatedEmojiData(
    '1f47e',
    name: 'alienMonster',
    categories: ['Smileys and emotions'],
    tags: [':alien-monster:'],
  ...
  static const sunWithFace = AnimatedEmojiData(
    '1f31e',
    name: 'sunWithFace',
    categories: ['Smileys and emotions'],
    tags: [':sun-with-face:'],
  ...
  static const moonFaceFirstQuarter = AnimatedEmojiData(
    '1f31b',
  ...
  static const moonFaceLastQuarter = AnimatedEmojiData(
    '1f31c',
    name: 'moonFaceLastQuarter',
    categories: ['Smileys and emotions'],
  ...
  static const smileyCat = AnimatedEmojiData(
    '1f63a',
    name: 'smileyCat',
    categories: ['Smileys and emotions'],
    tags: [':smiley-cat:'],
  ...
  static const smileCat = AnimatedEmojiData(
    '1f638',
    name: 'smileCat',
    categories: ['Smileys and emotions'],
    tags: [':smile-cat:'],
  ...
  static const joyCat = AnimatedEmojiData(
    '1f639',
    name: 'joyCat',
    categories: ['Smileys and emotions'],
    tags: [':joy-cat:'],
  ...
  static const heartEyesCat = AnimatedEmojiData(
    '1f63b',
    name: 'heartEyesCat',
    categories: ['Smileys and emotions'],
    tags: [':heart-eyes-cat:'],
  ...
  static const smirkCat = AnimatedEmojiData(
    '1f63c',
    name: 'smirkCat',
    categories: ['Smileys and emotions'],
    tags: [':smirk-cat:'],
  ...
  static const kissingCat = AnimatedEmojiData(
    '1f63d',
    name: 'kissingCat',
    categories: ['Smileys and emotions'],
    tags: [':kissing-cat:'],
  ...
  static const screamCat = AnimatedEmojiData(
    '1f640',
    name: 'screamCat',
    categories: ['Smileys and emotions'],
    tags: [':scream-cat:'],
  ...
  static const cryingCatFace = AnimatedEmojiData(
    '1f63f',
    name: 'cryingCatFace',
    categories: ['Smileys and emotions'],
  ...
  static const poutingCat = AnimatedEmojiData(
    '1f63e',
    name: 'poutingCat',
    categories: ['Smileys and emotions'],
    tags: [':pouting-cat:'],
  ...
  static const seeNoEvilMonkey = AnimatedEmojiData(
    '1f648',
  ...
  static const hearNoEvilMonkey = AnimatedEmojiData(
    '1f649',
  ...
  static const speakNoEvilMonkey = AnimatedEmojiData(
    '1f64a',
  ...
  static const glowingStar = AnimatedEmojiData(
    '1f31f',
    name: 'glowingStar',
    categories: ['Smileys and emotions'],
    tags: [':glowing-star:'],
  ...
  static const sparkles = AnimatedEmojiData(
    '2728',
    name: 'sparkles',
    categories: ['Smileys and emotions'],
    tags: [':sparkles:'],
  ...
  static const electricity = AnimatedEmojiData(
    '26a1',
    name: 'electricity',
    categories: ['Smileys and emotions'],
  ...
  static const collision = AnimatedEmojiData(
    '1f4a5',
    name: 'collision',
    categories: ['Smileys and emotions'],
    tags: [':collision:'],
  ...
  static const fire = AnimatedEmojiData(
    '1f525',
    name: 'fire',
    categories: ['Smileys and emotions'],
    tags: [':fire:', ':burn:', ':lit:'],
  ...
  static const oneHundred = AnimatedEmojiData(
    '1f4af',
    name: 'oneHundred',
    categories: ['Smileys and emotions'],
  ...
  static const partyPopper = AnimatedEmojiData(
    '1f389',
    name: 'partyPopper',
    categories: ['Smileys and emotions'],
    tags: [':party-popper:'],
  ...
  static const confettiBall = AnimatedEmojiData(
    '1f38a',
    name: 'confettiBall',
    categories: ['Smileys and emotions'],
    tags: [':confetti-ball:'],
  ...
  static const redHeart = AnimatedEmojiData(
    '2764_fe0f',
    name: 'redHeart',
    categories: ['Smileys and emotions'],
    tags: [':red-heart:'],
  ...
  static const orangeHeart = AnimatedEmojiData(
    '1f9e1',
    name: 'orangeHeart',
    categories: ['Smileys and emotions'],
    tags: [':orange-heart:'],
  ...
  static const yellowHeart = AnimatedEmojiData(
    '1f49b',
    name: 'yellowHeart',
    categories: ['Smileys and emotions'],
    tags: [':yellow-heart:'],
  ...
  static const greenHeart = AnimatedEmojiData(
    '1f49a',
    name: 'greenHeart',
    categories: ['Smileys and emotions'],
    tags: [':green-heart:'],
  ...
  static const lightBlueHeart = AnimatedEmojiData(
    '1fa75',
    name: 'lightBlueHeart',
    categories: ['Smileys and emotions'],
  ...
  static const blueHeart = AnimatedEmojiData(
    '1f499',
    name: 'blueHeart',
    categories: ['Smileys and emotions'],
    tags: [':blue-heart:'],
  ...
  static const purpleHeart = AnimatedEmojiData(
    '1f49c',
    name: 'purpleHeart',
    categories: ['Smileys and emotions'],
    tags: [':purple-heart:'],
  ...
  static const brownHeart = AnimatedEmojiData(
    '1f90e',
    name: 'brownHeart',
    categories: ['Smileys and emotions'],
    tags: [':brown-heart:'],
  ...
  static const blackHeart = AnimatedEmojiData(
    '1f5a4',
    name: 'blackHeart',
    categories: ['Smileys and emotions'],
    tags: [':black-heart:'],
  ...
  static const greyHeart = AnimatedEmojiData(
    '1fa76',
    name: 'greyHeart',
    categories: ['Smileys and emotions'],
    tags: [':grey-heart:'],
  ...
  static const whiteHeart = AnimatedEmojiData(
    '1f90d',
    name: 'whiteHeart',
    categories: ['Smileys and emotions'],
    tags: [':white-heart:'],
  ...
  static const pinkHeart = AnimatedEmojiData(
    '1fa77',
    name: 'pinkHeart',
    categories: ['Smileys and emotions'],
    tags: [':pink-heart:'],
  ...
  static const cupid = AnimatedEmojiData(
    '1f498',
    name: 'cupid',
    categories: ['Smileys and emotions'],
    tags: [':cupid:'],
  ...
  static const giftHeart = AnimatedEmojiData(
    '1f49d',
    name: 'giftHeart',
    categories: ['Smileys and emotions'],
    tags: [':gift-heart:'],
  ...
  static const sparklingHeart = AnimatedEmojiData(
    '1f496',
    name: 'sparklingHeart',
    categories: ['Smileys and emotions'],
  ...
  static const heartGrow = AnimatedEmojiData(
    '1f497',
    name: 'heartGrow',
    categories: ['Smileys and emotions'],
    tags: [':heart-grow:'],
  ...
  static const beatingHeart = AnimatedEmojiData(
    '1f493',
    name: 'beatingHeart',
    categories: ['Smileys and emotions'],
    tags: [':beating-heart:'],
  ...
  static const revolvingHearts = AnimatedEmojiData(
    '1f49e',
  ...
  static const twoHearts = AnimatedEmojiData(
    '1f495',
    name: 'twoHearts',
    categories: ['Smileys and emotions'],
    tags: [':two-hearts:'],
  ...
  static const loveLetter = AnimatedEmojiData(
    '1f48c',
    name: 'loveLetter',
    categories: ['Smileys and emotions'],
    tags: [':love-letter:'],
  ...
  static const heartBox = AnimatedEmojiData(
    '1f49f',
    name: 'heartBox',
    categories: ['Smileys and emotions'],
    tags: [':heart-box:'],
  ...
  static const heartExclamationPoint = AnimatedEmojiData(
    '2763_fe0f',
    name: 'heartExclamationPoint',
    categories: ['Smileys and emotions'],
  ...
  static const bandagedHeart = AnimatedEmojiData(
  ...
  static const brokenHeart = AnimatedEmojiData(
    '1f494',
    name: 'brokenHeart',
    categories: ['Smileys and emotions'],
    tags: [':broken-heart:'],
  ...
  static const fireHeart = AnimatedEmojiData(
  ...
  static const kiss = AnimatedEmojiData(
    '1f48b',
    name: 'kiss',
    categories: ['Smileys and emotions'],
    tags: [':kiss:'],
  ...
  static const footprints = AnimatedEmojiData(
    '1f463',
    name: 'footprints',
    categories: ['Smileys and emotions'],
    tags: [':footprints:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fac6/512.gif" alt="fingerprint" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fingerprint.
  static const fingerprint = AnimatedEmojiData(
    '1fac6',
    name: 'fingerprint',
    categories: ['Smileys and emotions'],
    tags: [':fingerprint:'],
  ...
  static const anatomicalHeart = AnimatedEmojiData(
    '1fac0',
  ...
  static const blood = AnimatedEmojiData(
    '1fa78',
    name: 'blood',
    categories: ['Smileys and emotions'],
    tags: [':blood:'],
  ...
  static const microbe = AnimatedEmojiData(
    '1f9a0',
    name: 'microbe',
    categories: ['Smileys and emotions'],
    tags: [':microbe:', ':virus:'],
  ...
  static const eyes = AnimatedEmojiData(
    '1f440',
    name: 'eyes',
    categories: ['Smileys and emotions'],
    tags: [':eyes:'],
  ...
  static const eye = AnimatedEmojiData(
    '1f441_fe0f',
    name: 'eye',
    categories: ['Smileys and emotions'],
    tags: [':eye:'],
  ...
  static const bitingLip = AnimatedEmojiData(
    '1fae6',
    name: 'bitingLip',
    categories: ['Smileys and emotions'],
    tags: [':biting-lip:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f443/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f443/512.gif" alt="nose" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of nose.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const nose = AnimatedTonedEmojiData(
    '1f443',
    name: 'nose',
    categories: ['Smileys and emotions'],
    tags: [':nose:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f442/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f442/512.gif" alt="ear" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of ear.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const ear = AnimatedTonedEmojiData(
    '1f442',
    name: 'ear',
    categories: ['Smileys and emotions'],
    tags: [':ear:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9bb/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9bb/512.gif" alt="hearingAid" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of hearingAid.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const hearingAid = AnimatedTonedEmojiData(
    '1f9bb',
    name: 'hearingAid',
    categories: ['Smileys and emotions'],
    tags: [':hearing-aid:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9b6/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9b6/512.gif" alt="foot" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of foot.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const foot = AnimatedTonedEmojiData(
    '1f9b6',
    name: 'foot',
    categories: ['Smileys and emotions'],
    tags: [':foot:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9b5/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f9b5/512.gif" alt="leg" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of leg.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const leg = AnimatedTonedEmojiData(
    '1f9b5',
    name: 'leg',
    categories: ['Smileys and emotions'],
    tags: [':leg:'],
  ...
  static const legMechanical = AnimatedEmojiData(
    '1f9bf',
    name: 'legMechanical',
    categories: ['Smileys and emotions'],
    tags: [':leg-mechanical:'],
  ...
  static const armMechanical = AnimatedEmojiData(
    '1f9be',
    name: 'armMechanical',
    categories: ['Smileys and emotions'],
    tags: [':arm-mechanical:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const muscle = AnimatedTonedEmojiData(
    '1f4aa',
    name: 'muscle',
    categories: ['Smileys and emotions'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const clap = AnimatedTonedEmojiData(
    '1f44f',
    name: 'clap',
    categories: ['Smileys and emotions'],
    tags: [':clap:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const thumbsDown = AnimatedTonedEmojiData(
    '1f44e',
    name: 'thumbsDown',
    categories: ['Smileys and emotions'],
    tags: [':thumbs-down:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf6/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf6/512.gif" alt="heartHands" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of heartHands.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const heartHands = AnimatedTonedEmojiData(
    '1faf6',
    name: 'heartHands',
    categories: ['Smileys and emotions'],
    tags: [':heart-hands:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const raisingHands = AnimatedTonedEmojiData(
    '1f64c',
    name: 'raisingHands',
    categories: ['Smileys and emotions'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f450/512.gif" alt="openHands" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of openHands.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const openHands = AnimatedTonedEmojiData(
    '1f450',
    name: 'openHands',
    categories: ['Smileys and emotions'],
    tags: [':open-hands:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f932/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f932/512.gif" alt="palmsUp" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of palmsUp.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const palmsUp = AnimatedTonedEmojiData(
    '1f932',
    name: 'palmsUp',
    categories: ['Smileys and emotions'],
    tags: [':palms-up:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91c/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91c/512.gif" alt="fistRightwards" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fistRightwards.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const fistRightwards = AnimatedTonedEmojiData(
    '1f91c',
    name: 'fistRightwards',
    categories: ['Smileys and emotions'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91b/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91b/512.gif" alt="fistLeftwards" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fistLeftwards.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const fistLeftwards = AnimatedTonedEmojiData(
    '1f91b',
    name: 'fistLeftwards',
    categories: ['Smileys and emotions'],
    tags: [':fist-leftwards:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/270a/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/270a/512.gif" alt="raisedFist" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of raisedFist.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const raisedFist = AnimatedTonedEmojiData(
    '270a',
    name: 'raisedFist',
    categories: ['Smileys and emotions'],
    tags: [':raised-fist:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f44a/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f44a/512.gif" alt="fist" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fist.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const fist = AnimatedTonedEmojiData(
    '1f44a',
    name: 'fist',
    categories: ['Smileys and emotions'],
    tags: [':fist:', ':bump:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf3/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf3/512.gif" alt="palmDown" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of palmDown.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const palmDown = AnimatedTonedEmojiData(
    '1faf3',
    name: 'palmDown',
    categories: ['Smileys and emotions'],
    tags: [':palm-down:', ':drop:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf4/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf4/512.gif" alt="palmUp" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of palmUp.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const palmUp = AnimatedTonedEmojiData(
    '1faf4',
    name: 'palmUp',
    categories: ['Smileys and emotions'],
    tags: [':palm-up:', ':throw:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf1/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf1/512.gif" alt="rightwardsHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of rightwardsHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const rightwardsHand = AnimatedTonedEmojiData(
    '1faf1',
    name: 'rightwardsHand',
    categories: ['Smileys and emotions'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf2/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf2/512.gif" alt="leftwardsHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of leftwardsHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const leftwardsHand = AnimatedTonedEmojiData(
    '1faf2',
    name: 'leftwardsHand',
    categories: ['Smileys and emotions'],
    tags: [':leftwards-hand:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf8/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf8/512.gif" alt="pushRightwards" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pushRightwards.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pushRightwards = AnimatedTonedEmojiData(
    '1faf8',
    name: 'pushRightwards',
    categories: ['Smileys and emotions'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf7/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf7/512.gif" alt="pushLeftwards" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pushLeftwards.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pushLeftwards = AnimatedTonedEmojiData(
    '1faf7',
    name: 'pushLeftwards',
    categories: ['Smileys and emotions'],
    tags: [':push-leftwards:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const wave = AnimatedTonedEmojiData(
    '1f44b',
    name: 'wave',
    categories: ['Smileys and emotions'],
    tags: [':wave:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91a/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91a/512.gif" alt="backHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of backHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const backHand = AnimatedTonedEmojiData(
    '1f91a',
    name: 'backHand',
    categories: ['Smileys and emotions'],
    tags: [':back-hand:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f590_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f590_fe0f/512.gif" alt="palm" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of palm.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const palm = AnimatedTonedEmojiData(
    '1f590',
    name: 'palm',
    categories: ['Smileys and emotions'],
    tags: [':palm:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/270b/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/270b/512.gif" alt="raisedHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of raisedHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const raisedHand = AnimatedTonedEmojiData(
    '270b',
    name: 'raisedHand',
    categories: ['Smileys and emotions'],
    tags: [':raised-hand:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f596/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f596/512.gif" alt="vulcan" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of vulcan.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const vulcan = AnimatedTonedEmojiData(
    '1f596',
    name: 'vulcan',
    categories: ['Smileys and emotions'],
  ...
  ///</picture>
  ///
  /// Animated emoji of metal.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const metal = AnimatedTonedEmojiData(
    '1f918',
    name: 'metal',
    categories: ['Smileys and emotions'],
    tags: [':metal:', ':horns:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const victory = AnimatedTonedEmojiData(
    '270c',
    name: 'victory',
    categories: ['Smileys and emotions'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const crossedFingers = AnimatedTonedEmojiData(
    '1f91e',
    name: 'crossedFingers',
    categories: ['Smileys and emotions'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf0/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf0/512.gif" alt="handWithIndexFingerAndThumbCrossed" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of handWithIndexFingerAndThumbCrossed.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const handWithIndexFingerAndThumbCrossed = AnimatedTonedEmojiData(
    '1faf0',
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f919/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f919/512.gif" alt="callMeHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of callMeHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const callMeHand = AnimatedTonedEmojiData(
    '1f919',
    name: 'callMeHand',
    categories: ['Smileys and emotions'],
    tags: [':call-me-hand:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f90c/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f90c/512.gif" alt="pinchedFingers" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pinchedFingers.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pinchedFingers = AnimatedTonedEmojiData(
    '1f90c',
    name: 'pinchedFingers',
    categories: ['Smileys and emotions'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f90f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f90f/512.gif" alt="pinch" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pinch.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pinch = AnimatedTonedEmojiData(
    '1f90f',
    name: 'pinch',
    categories: ['Smileys and emotions'],
    tags: [':pinch:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f44c/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f44c/512.gif" alt="ok" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of ok.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const ok = AnimatedTonedEmojiData(
    '1f44c',
    name: 'ok',
    categories: ['Smileys and emotions'],
    tags: [':ok:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf5/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faf5/512.gif" alt="pointing" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pointing.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pointing = AnimatedTonedEmojiData(
    '1faf5',
    name: 'pointing',
    categories: ['Smileys and emotions'],
    tags: [':pointing:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f449/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f449/512.gif" alt="pointRight" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pointRight.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pointRight = AnimatedTonedEmojiData(
    '1f449',
    name: 'pointRight',
    categories: ['Smileys and emotions'],
    tags: [':point-right:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f448/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f448/512.gif" alt="pointLeft" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pointLeft.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pointLeft = AnimatedTonedEmojiData(
    '1f448',
    name: 'pointLeft',
    categories: ['Smileys and emotions'],
    tags: [':point-left:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const indexFinger = AnimatedTonedEmojiData(
    '261d',
    name: 'indexFinger',
    categories: ['Smileys and emotions'],
    tags: [':index-finger:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f446/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f446/512.gif" alt="pointUp" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pointUp.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pointUp = AnimatedTonedEmojiData(
    '1f446',
    name: 'pointUp',
    categories: ['Smileys and emotions'],
    tags: [':point-up:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f447/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f447/512.gif" alt="pointDown" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pointDown.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const pointDown = AnimatedTonedEmojiData(
    '1f447',
    name: 'pointDown',
    categories: ['Smileys and emotions'],
    tags: [':point-down:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f595/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f595/512.gif" alt="middleFinger" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of middleFinger.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const middleFinger = AnimatedTonedEmojiData(
    '1f595',
    name: 'middleFinger',
    categories: ['Smileys and emotions'],
    tags: [':middle-finger:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/270d_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/270d_fe0f/512.gif" alt="writingHand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of writingHand.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const writingHand = AnimatedTonedEmojiData(
    '270d',
    name: 'writingHand',
    categories: ['Smileys and emotions'],
    tags: [':writing-hand:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f933/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f933/512.gif" alt="selfie" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of selfie.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const selfie = AnimatedTonedEmojiData(
    '1f933',
    name: 'selfie',
    categories: ['Smileys and emotions'],
    tags: [':selfie:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const foldedHands = AnimatedTonedEmojiData(
    '1f64f',
    name: 'foldedHands',
    categories: [
      'Smileys and emotions',
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f485/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f485/512.gif" alt="nailCare" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of nailCare.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const nailCare = AnimatedTonedEmojiData(
    '1f485',
    name: 'nailCare',
    categories: ['Smileys and emotions'],
    tags: [':nail-care:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f91d/512.gif" alt="handshake" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of handshake.
  ///
  /// This emoji has skin tone variations.
  ///
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const handshake = AnimatedTonedEmojiData(
    '1f91d',
    name: 'handshake',
    categories: ['Smileys and emotions'],
    tags: [':handshake:'],
  ...
  /// See also:
  /// - [AnimatedTonedEmojiData] for an example on how to use skin tone variations.
  static const dancerWoman = AnimatedTonedEmojiData(
    '1f483',
    name: 'dancerWoman',
    categories: ['People'],
    tags: [':dancer-woman:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f490/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f490/512.gif" alt="bouquet" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of bouquet.
  static const bouquet = AnimatedEmojiData(
    '1f490',
    name: 'bouquet',
  ...
  static const rose = AnimatedEmojiData(
    '1f339',
    name: 'rose',
    categories: ['Animals and nature'],
    tags: [':rose:'],
  ...
  static const wiltedFlower = AnimatedEmojiData(
    '1f940',
    name: 'wiltedFlower',
    categories: ['Animals and nature'],
    tags: [':wilted-flower:'],
  ...
  static const fallenLeaf = AnimatedEmojiData(
    '1f342',
    name: 'fallenLeaf',
    categories: ['Animals and nature'],
    tags: [':fallen-leaf:'],
  ...
  static const plant = AnimatedEmojiData(
    '1f331',
    name: 'plant',
    categories: ['Animals and nature'],
    tags: [':plant:', ':seed:'],
  ...
  static const leaves = AnimatedEmojiData(
    '1f343',
    name: 'leaves',
    categories: ['Animals and nature'],
    tags: [':leaves:'],
  ...
  static const luck = AnimatedEmojiData(
    '1f340',
    name: 'luck',
    categories: ['Animals and nature'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fabe/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fabe/512.gif" alt="leaflessTree" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of leaflessTree.
  static const leaflessTree = AnimatedEmojiData(
    '1fabe',
    name: 'leaflessTree',
    categories: ['Animals and nature'],
    tags: [':leafless-tree:'],
  ...
  static const snowflake = AnimatedEmojiData(
    '2744_fe0f',
    name: 'snowflake',
    categories: ['Animals and nature'],
  ...
  static const volcano = AnimatedEmojiData(
    '1f30b',
    name: 'volcano',
    categories: ['Animals and nature'],
    tags: [':volcano:'],
  ...
  static const sunrise = AnimatedEmojiData(
    '1f305',
    name: 'sunrise',
    categories: ['Animals and nature'],
    tags: [':sunrise:'],
  ...
  static const sunriseOverMountains = AnimatedEmojiData(
    '1f304',
  ...
  static const rainbow = AnimatedEmojiData(
    '1f308',
    name: 'rainbow',
    categories: ['Animals and nature'],
    tags: [':rainbow:'],
  ...
  static const bubbles = AnimatedEmojiData(
    '1fae7',
    name: 'bubbles',
    categories: ['Animals and nature'],
    tags: [':bubbles:'],
  ...
  static const ocean = AnimatedEmojiData(
    '1f30a',
    name: 'ocean',
    categories: ['Animals and nature'],
    tags: [':ocean:'],
  ...
  static const windFace = AnimatedEmojiData(
    '1f32c_fe0f',
    name: 'windFace',
    categories: ['Animals and nature'],
    tags: [':wind-face:'],
  ...
  static const tornado = AnimatedEmojiData(
    '1f32a_fe0f',
    name: 'tornado',
    categories: ['Animals and nature'],
    tags: [':tornado:'],
  ...
  static const droplet = AnimatedEmojiData(
    '1f4a7',
    name: 'droplet',
    categories: ['Animals and nature'],
    tags: [':droplet:'],
  ...
  static const rainCloud = AnimatedEmojiData(
    '1f327_fe0f',
    name: 'rainCloud',
    categories: ['Animals and nature'],
    tags: [':rain-cloud:'],
  ...
  static const cloudWithLightning = AnimatedEmojiData(
    '1f329_fe0f',
  ...
  static const globeShowingEuropeAfrica = AnimatedEmojiData(
    '1f30d',
  ...
  static const globeShowingAmericas = AnimatedEmojiData(
    '1f30e',
  ...
  static const globeShowingAsiaAustralia = AnimatedEmojiData(
    '1f30f',
  ...
  static const comet = AnimatedEmojiData(
    '2604_fe0f',
    name: 'comet',
    categories: ['Animals and nature'],
    tags: [':comet:'],
  ...
  static const cowFace = AnimatedEmojiData(
    '1f42e',
    name: 'cowFace',
    categories: ['Animals and nature'],
    tags: [':cow-face:'],
  ...
  static const unicorn = AnimatedEmojiData(
    '1f984',
    name: 'unicorn',
    categories: ['Animals and nature'],
    tags: [':unicorn:'],
  ...
  static const lizard = AnimatedEmojiData(
    '1f98e',
    name: 'lizard',
    categories: ['Animals and nature'],
    tags: [':lizard:'],
  ...
  static const dragon = AnimatedEmojiData(
    '1f409',
    name: 'dragon',
    categories: ['Animals and nature'],
    tags: [':dragon:'],
  ...
  static const tRex = AnimatedEmojiData(
    '1f996',
    name: 'tRex',
    categories: ['Animals and nature'],
    tags: [':t-rex:'],
  ...
  static const dinosaur = AnimatedEmojiData(
    '1f995',
    name: 'dinosaur',
    categories: ['Animals and nature'],
    tags: [':dinosaur:'],
  ...
  static const turtle = AnimatedEmojiData(
    '1f422',
    name: 'turtle',
    categories: ['Animals and nature'],
    tags: [':turtle:'],
  ...
  static const crocodile = AnimatedEmojiData(
    '1f40a',
    name: 'crocodile',
    categories: ['Animals and nature'],
    tags: [':crocodile:'],
  ...
  static const snake = AnimatedEmojiData(
    '1f40d',
    name: 'snake',
    categories: ['Animals and nature'],
    tags: [':snake:'],
  ...
  static const frog = AnimatedEmojiData(
    '1f438',
    name: 'frog',
    categories: ['Animals and nature'],
    tags: [':frog:'],
  ...
  static const rabbit = AnimatedEmojiData(
    '1f407',
    name: 'rabbit',
    categories: ['Animals and nature'],
    tags: [':rabbit:'],
  ...
  static const rat = AnimatedEmojiData(
    '1f400',
    name: 'rat',
    categories: ['Animals and nature'],
    tags: [':rat:'],
  ...
  static const poodle = AnimatedEmojiData(
    '1f429',
    name: 'poodle',
    categories: ['Animals and nature'],
    tags: [':poodle:'],
  ...
  static const dog = AnimatedEmojiData(
    '1f415',
    name: 'dog',
    categories: ['Animals and nature'],
    tags: [':dog:'],
  ...
  static const guideDog = AnimatedEmojiData(
    '1f9ae',
    name: 'guideDog',
    categories: ['Animals and nature'],
    tags: [':guide-dog:'],
  ...
  static const serviceDog = AnimatedEmojiData(
    '1f415_200d_1f9ba',
    name: 'serviceDog',
    categories: ['Animals and nature'],
    tags: [':service-dog:'],
  ...
  static const pig = AnimatedEmojiData(
    '1f416',
    name: 'pig',
    categories: ['Animals and nature'],
    tags: [':pig:'],
  ...
  static const racehorse = AnimatedEmojiData(
    '1f40e',
    name: 'racehorse',
    categories: ['Animals and nature'],
    tags: [':racehorse:'],
  ...
  static const donkey = AnimatedEmojiData(
    '1facf',
    name: 'donkey',
    categories: ['Animals and nature'],
    tags: [':donkey:'],
  ...
  static const ox = AnimatedEmojiData(
    '1f402',
    name: 'ox',
    categories: ['Animals and nature'],
    tags: [':ox:'],
  ...
  static const goat = AnimatedEmojiData(
    '1f410',
    name: 'goat',
    categories: ['Animals and nature'],
    tags: [':goat:'],
  ...
  static const kangaroo = AnimatedEmojiData(
    '1f998',
    name: 'kangaroo',
    categories: ['Animals and nature'],
    tags: [':kangaroo:'],
  ...
  static const tiger = AnimatedEmojiData(
    '1f405',
    name: 'tiger',
    categories: ['Animals and nature'],
    tags: [':tiger:'],
  ...
  static const monkey = AnimatedEmojiData(
    '1f412',
    name: 'monkey',
    categories: ['Animals and nature'],
    tags: [':monkey:'],
  ...
  static const gorilla = AnimatedEmojiData(
    '1f98d',
    name: 'gorilla',
    categories: ['Animals and nature'],
    tags: [':gorilla:'],
  ...
  static const orangutan = AnimatedEmojiData(
    '1f9a7',
    name: 'orangutan',
    categories: ['Animals and nature'],
    tags: [':orangutan:'],
  ...
  static const chipmunk = AnimatedEmojiData(
    '1f43f_fe0f',
    name: 'chipmunk',
    categories: ['Animals and nature'],
    tags: [':chipmunk:'],
  ...
  static const otter = AnimatedEmojiData(
    '1f9a6',
    name: 'otter',
    categories: ['Animals and nature'],
    tags: [':otter:'],
  ...
  static const bat = AnimatedEmojiData(
    '1f987',
    name: 'bat',
    categories: ['Animals and nature'],
    tags: [':bat:'],
  ...
  static const bird = AnimatedEmojiData(
    '1f426',
    name: 'bird',
    categories: ['Animals and nature'],
    tags: [':bird:'],
  ...
  static const blackBird = AnimatedEmojiData(
    '1f426_200d_2b1b',
    name: 'blackBird',
    categories: ['Animals and nature'],
    tags: [':black-bird:'],
  ...
  static const rooster = AnimatedEmojiData(
    '1f413',
    name: 'rooster',
    categories: ['Animals and nature'],
    tags: [':rooster:'],
  ...
  static const hatchingChick = AnimatedEmojiData(
    '1f423',
    name: 'hatchingChick',
    categories: ['Animals and nature'],
    tags: [':hatching-chick:'],
  ...
  static const babyChick = AnimatedEmojiData(
    '1f424',
    name: 'babyChick',
    categories: ['Animals and nature'],
    tags: [':baby-chick:'],
  ...
  static const hatchedChick = AnimatedEmojiData(
    '1f425',
    name: 'hatchedChick',
    categories: ['Animals and nature'],
    tags: [':hatched-chick:'],
  ...
  static const eagle = AnimatedEmojiData(
    '1f985',
    name: 'eagle',
    categories: ['Animals and nature'],
    tags: [':eagle:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f989/512.gif" alt="owl" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of owl.
  static const owl = AnimatedEmojiData(
    '1f989',
    name: 'owl',
    categories: ['Animals and nature'],
    tags: [':owl:'],
  ...
  static const peace = AnimatedEmojiData(
    '1f54a_fe0f',
    name: 'peace',
    categories: ['Animals and nature'],
    tags: [':peace:', ':dove:'],
  ...
  static const goose = AnimatedEmojiData(
    '1fabf',
    name: 'goose',
    categories: ['Animals and nature'],
    tags: [':goose:'],
  ...
  static const peacock = AnimatedEmojiData(
    '1f99a',
    name: 'peacock',
    categories: ['Animals and nature'],
    tags: [':peacock:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f426_200d_1f525/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f426_200d_1f525/512.gif" alt="phoenix" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of phoenix.
  static const phoenix = AnimatedEmojiData(
    '1f426_200d_1f525',
    name: 'phoenix',
    categories: ['Animals and nature'],
    tags: [':phoenix:'],
  ...
  static const seal = AnimatedEmojiData(
    '1f9ad',
    name: 'seal',
    categories: ['Animals and nature'],
    tags: [':seal:'],
  ...
  static const shark = AnimatedEmojiData(
    '1f988',
    name: 'shark',
    categories: ['Animals and nature'],
    tags: [':shark:'],
  ...
  static const dolphin = AnimatedEmojiData(
    '1f42c',
    name: 'dolphin',
    categories: ['Animals and nature'],
    tags: [':dolphin:'],
  ...
  static const whale = AnimatedEmojiData(
    '1f433',
    name: 'whale',
    categories: ['Animals and nature'],
    tags: [':whale:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f41f/512.gif" alt="fish" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fish.
  static const fish = AnimatedEmojiData(
    '1f41f',
    name: 'fish',
    categories: ['Animals and nature'],
    tags: [':fish:'],
  ...
  static const blowfish = AnimatedEmojiData(
    '1f421',
    name: 'blowfish',
    categories: ['Animals and nature'],
    tags: [':blowfish:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f99e/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f99e/512.gif" alt="lobster" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of lobster.
  static const lobster = AnimatedEmojiData(
    '1f99e',
    name: 'lobster',
    categories: ['Animals and nature'],
    tags: [':lobster:'],
  ...
  static const crab = AnimatedEmojiData(
    '1f980',
    name: 'crab',
    categories: ['Animals and nature'],
    tags: [':crab:'],
  ...
  static const octopus = AnimatedEmojiData(
    '1f419',
    name: 'octopus',
    categories: ['Animals and nature'],
    tags: [':octopus:'],
  ...
  static const jellyfish = AnimatedEmojiData(
    '1fabc',
    name: 'jellyfish',
    categories: ['Animals and nature'],
    tags: [':jellyfish:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f982/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f982/512.gif" alt="scorpion" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of scorpion.
  static const scorpion = AnimatedEmojiData(
    '1f982',
    name: 'scorpion',
    categories: ['Animals and nature'],
    tags: [':scorpion:'],
  ...
  static const spider = AnimatedEmojiData(
    '1f577_fe0f',
    name: 'spider',
    categories: ['Animals and nature'],
    tags: [':spider:'],
  ...
  static const snail = AnimatedEmojiData(
    '1f40c',
    name: 'snail',
    categories: ['Animals and nature'],
    tags: [':snail:'],
  ...
  static const ant = AnimatedEmojiData(
    '1f41c',
    name: 'ant',
    categories: ['Animals and nature'],
    tags: [':ant:'],
  ...
  static const mosquito = AnimatedEmojiData(
    '1f99f',
    name: 'mosquito',
    categories: ['Animals and nature'],
    tags: [':mosquito:'],
  ...
  static const cockroach = AnimatedEmojiData(
    '1fab3',
    name: 'cockroach',
    categories: ['Animals and nature'],
    tags: [':cockroach:'],
  ...
  static const fly = AnimatedEmojiData(
    '1fab0',
    name: 'fly',
    categories: ['Animals and nature'],
    tags: [':fly:'],
  ...
  static const bee = AnimatedEmojiData(
    '1f41d',
    name: 'bee',
    categories: ['Animals and nature'],
    tags: [':bee:'],
  ...
  static const ladyBug = AnimatedEmojiData(
    '1f41e',
    name: 'ladyBug',
    categories: ['Animals and nature'],
    tags: [':lady-bug:'],
  ...
  static const butterfly = AnimatedEmojiData(
    '1f98b',
    name: 'butterfly',
    categories: ['Animals and nature'],
    tags: [':butterfly:'],
  ...
  static const bug = AnimatedEmojiData(
    '1f41b',
    name: 'bug',
    categories: ['Animals and nature'],
    tags: [':bug:'],
  ...
  static const worm = AnimatedEmojiData(
    '1fab1',
    name: 'worm',
    categories: ['Animals and nature'],
    tags: [':worm:'],
  ...
  static const pawPrints = AnimatedEmojiData(
    '1f43e',
    name: 'pawPrints',
    categories: ['Animals and nature'],
    tags: [':paw prints:'],
  ...
  static const tomato = AnimatedEmojiData(
    '1f345',
    name: 'tomato',
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fadc/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fadc/512.gif" alt="rootVegetable" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of rootVegetable.
  static const rootVegetable = AnimatedEmojiData(
    '1fadc',
    name: 'rootVegetable',
    categories: ['Food and drink'],
  ...
  static const cooking = AnimatedEmojiData(
    '1f373',
    name: 'cooking',
    categories: ['Food and drink'],
    tags: [':cooking:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f32f/512.gif" alt="burrito" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of burrito.
  static const burrito = AnimatedEmojiData(
    '1f32f',
    name: 'burrito',
    categories: ['Food and drink'],
    tags: [':burrito:'],
  ...
  static const spaghetti = AnimatedEmojiData(
    '1f35d',
    name: 'spaghetti',
    categories: ['Food and drink'],
    tags: [':spaghetti:'],
  ...
  static const steamingBowl = AnimatedEmojiData(
    '1f35c',
    name: 'steamingBowl',
    categories: ['Food and drink'],
    tags: [':steaming-bowl:'],
  ...
  static const popcorn = AnimatedEmojiData(
    '1f37f',
    name: 'popcorn',
    categories: ['Food and drink'],
    tags: [':popcorn:'],
  ...
  static const hotBeverage = AnimatedEmojiData(
    '2615',
    name: 'hotBeverage',
    categories: ['Food and drink'],
    tags: [':hot-beverage:'],
  ...
  static const clinkingBeerMugs = AnimatedEmojiData(
    '1f37b',
  ...
  static const clinkingGlasses = AnimatedEmojiData(
    '1f942',
  ...
  static const bottleWithPoppingCork = AnimatedEmojiData(
    '1f37e',
  ...
  static const wineGlass = AnimatedEmojiData(
    '1f377',
    name: 'wineGlass',
    categories: ['Food and drink'],
    tags: [':wine-glass:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fad7/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fad7/512.gif" alt="pour" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of pour.
  static const pour = AnimatedEmojiData(
    '1fad7',
    name: 'pour',
    categories: ['Food and drink'],
    tags: [':pour:'],
  ...
  static const tropicalDrink = AnimatedEmojiData(
    '1f379',
    name: 'tropicalDrink',
    categories: ['Food and drink'],
    tags: [':tropical-drink:'],
  ...
  static const construction = AnimatedEmojiData(
    '1f6a7',
    name: 'construction',
  ...
  static const policeCarLight = AnimatedEmojiData(
    '1f6a8',
    name: 'policeCarLight',
    categories: ['Travel and places'],
  ...
  static const bicycle = AnimatedEmojiData(
    '1f6b2',
    name: 'bicycle',
    categories: ['Travel and places'],
    tags: [':bicycle:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f697/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f697/512.gif" alt="automobile" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of automobile.
  static const automobile = AnimatedEmojiData(
    '1f697',
    name: 'automobile',
    categories: ['Travel and places'],
    tags: [':automobile:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3ce_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3ce_fe0f/512.gif" alt="racingCar" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of racingCar.
  static const racingCar = AnimatedEmojiData(
    '1f3ce_fe0f',
    name: 'racingCar',
    categories: ['Travel and places'],
    tags: [':racing-car:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f695/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f695/512.gif" alt="taxi" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of taxi.
  static const taxi = AnimatedEmojiData(
    '1f695',
    name: 'taxi',
    categories: ['Travel and places'],
    tags: [':taxi:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f68c/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f68c/512.gif" alt="bus" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of bus.
  static const bus = AnimatedEmojiData(
    '1f68c',
    name: 'bus',
    categories: ['Travel and places'],
    tags: [':bus:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/26f5/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26f5/512.gif" alt="sailboat" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of sailboat.
  static const sailboat = AnimatedEmojiData(
    '26f5',
    name: 'sailboat',
    categories: ['Travel and places'],
    tags: [':sailboat:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f6f6/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f6f6/512.gif" alt="canoe" width="32" height="32">
  ///</picture>
  ///
  ...
  static const flyingSaucer = AnimatedEmojiData(
    '1f6f8',
    name: 'flyingSaucer',
    categories: ['Travel and places'],
    tags: [':flying-saucer:'],
  ...
  static const rocket = AnimatedEmojiData(
    '1f680',
    name: 'rocket',
    categories: ['Travel and places'],
    tags: [':rocket:'],
  ...
  static const airplaneDeparture = AnimatedEmojiData(
    '1f6eb',
  ...
  static const airplaneArrival = AnimatedEmojiData(
    '1f6ec',
  ...
  static const rollerCoaster = AnimatedEmojiData(
    '1f3a2',
    name: 'rollerCoaster',
    categories: ['Travel and places'],
    tags: [':roller-coaster:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3a1/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3a1/512.gif" alt="ferrisWheel" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of ferrisWheel.
  static const ferrisWheel = AnimatedEmojiData(
    '1f3a1',
    name: 'ferrisWheel',
    categories: ['Travel and places'],
    tags: [':ferris-wheel:'],
  ...
  static const camping = AnimatedEmojiData(
    '1f3d5_fe0f',
    name: 'camping',
    categories: ['Travel and places'],
    tags: [':camping:'],
  ...
  static const balloon = AnimatedEmojiData(
    '1f388',
    name: 'balloon',
  ...
  static const birthdayCake = AnimatedEmojiData(
    '1f382',
    name: 'birthdayCake',
    categories: ['Activities and events'],
    tags: [':birthday-cake:'],
  ...
  static const wrappedGift = AnimatedEmojiData(
    '1f381',
    name: 'wrappedGift',
    categories: ['Activities and events'],
    tags: [':wrapped-gift:'],
  ...
  static const fireworks = AnimatedEmojiData(
    '1f386',
    name: 'fireworks',
    categories: ['Activities and events'],
    tags: [':fireworks:'],
  ...
  static const pinata = AnimatedEmojiData(
    '1fa85',
    name: 'pinata',
    categories: ['Activities and events'],
    tags: [':piñata:'],
  ...
  static const mirrorBall = AnimatedEmojiData(
    '1faa9',
    name: 'mirrorBall',
    categories: ['Activities and events'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f947/512.gif" alt="goldMedal" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of goldMedal.
  static const goldMedal = AnimatedEmojiData(
    '1f947',
    name: 'goldMedal',
    categories: ['Activities and events'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f948/512.gif" alt="silverMedal" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of silverMedal.
  static const silverMedal = AnimatedEmojiData(
    '1f948',
    name: 'silverMedal',
    categories: ['Activities and events'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f949/512.gif" alt="bronzeMedal" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of bronzeMedal.
  static const bronzeMedal = AnimatedEmojiData(
    '1f949',
    name: 'bronzeMedal',
    categories: ['Activities and events'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3c6/512.gif" alt="trophy" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of trophy.
  static const trophy = AnimatedEmojiData(
    '1f3c6',
    name: 'trophy',
    categories: ['Activities and events'],
    tags: [':trophy:'],
  ...
  static const soccerBall = AnimatedEmojiData(
    '26bd',
    name: 'soccerBall',
    categories: ['Activities and events'],
    tags: [':soccer-ball:'],
  ...
  static const baseball = AnimatedEmojiData(
    '26be',
    name: 'baseball',
    categories: ['Activities and events'],
    tags: [':baseball:'],
  ...
  static const softball = AnimatedEmojiData(
    '1f94e',
    name: 'softball',
    categories: ['Activities and events'],
    tags: [':softball:'],
  ...
  static const tennis = AnimatedEmojiData(
    '1f3be',
    name: 'tennis',
    categories: ['Activities and events'],
    tags: [':tennis:'],
  ...
  static const badminton = AnimatedEmojiData(
    '1f3f8',
    name: 'badminton',
    categories: ['Activities and events'],
    tags: [':badminton:'],
  ...
  static const lacrosse = AnimatedEmojiData(
    '1f94d',
    name: 'lacrosse',
    categories: ['Activities and events'],
    tags: [':lacrosse:'],
  ...
  static const cricketGame = AnimatedEmojiData(
    '1f3cf',
    name: 'cricketGame',
    categories: ['Activities and events'],
    tags: [':cricket-game:'],
  ...
  static const fieldHockey = AnimatedEmojiData(
    '1f3d1',
    name: 'fieldHockey',
    categories: ['Activities and events'],
    tags: [':field-hockey:'],
  ...
  static const iceHockey = AnimatedEmojiData(
    '1f3d2',
    name: 'iceHockey',
    categories: ['Activities and events'],
    tags: [':ice-hockey:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/26f8_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26f8_fe0f/512.gif" alt="iceSkate" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of iceSkate.
  static const iceSkate = AnimatedEmojiData(
    '26f8_fe0f',
    name: 'iceSkate',
    categories: ['Activities and events'],
    tags: [':ice-skate:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f6fc/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f6fc/512.gif" alt="rollerSkates" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of rollerSkates.
  static const rollerSkates = AnimatedEmojiData(
    '1f6fc',
    name: 'rollerSkates',
    categories: ['Activities and events'],
    tags: [':roller-skates:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa70/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa70/512.gif" alt="balletShoes" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of balletShoes.
  static const balletShoes = AnimatedEmojiData(
    '1fa70',
    name: 'balletShoes',
    categories: ['Activities and events'],
    tags: [':ballet-shoes:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f6f9/512.gif" alt="skateboard" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of skateboard.
  static const skateboard = AnimatedEmojiData(
    '1f6f9',
    name: 'skateboard',
    categories: ['Activities and events'],
    tags: [':skateboard:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/26f3/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26f3/512.gif" alt="flagInHole" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of flagInHole.
  static const flagInHole = AnimatedEmojiData(
    '26f3',
    name: 'flagInHole',
    categories: ['Activities and events'],
    tags: [':flag-in-hole:'],
  ...
  static const directHit = AnimatedEmojiData(
    '1f3af',
    name: 'directHit',
    categories: ['Activities and events'],
  ...
  static const flyingDisc = AnimatedEmojiData(
    '1f94f',
    name: 'flyingDisc',
    categories: ['Activities and events'],
    tags: [':flying-disc:'],
  ...
  static const boomerang = AnimatedEmojiData(
    '1fa83',
    name: 'boomerang',
    categories: ['Activities and events'],
    tags: [':boomerang:'],
  ...
  static const kite = AnimatedEmojiData(
    '1fa81',
    name: 'kite',
    categories: ['Activities and events'],
    tags: [':kite:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3a3/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3a3/512.gif" alt="fishingPole" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fishingPole.
  static const fishingPole = AnimatedEmojiData(
    '1f3a3',
    name: 'fishingPole',
    categories: ['Activities and events'],
    tags: [':fishing-pole:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f94b/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f94b/512.gif" alt="martialArtsUniform" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of martialArtsUniform.
  static const martialArtsUniform = AnimatedEmojiData(
    '1f94b',
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3b1/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3b1/512.gif" alt="eightBall" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of eightBall.
  static const eightBall = AnimatedEmojiData(
    '1f3b1',
    name: 'eightBall',
    categories: ['Activities and events'],
    tags: [':8-ball:'],
  ...
  static const pingPong = AnimatedEmojiData(
    '1f3d3',
    name: 'pingPong',
    categories: ['Activities and events'],
    tags: [':ping-pong:'],
  ...
  static const bowling = AnimatedEmojiData(
    '1f3b3',
    name: 'bowling',
    categories: ['Activities and events'],
    tags: [':bowling:'],
  ...
  static const die = AnimatedEmojiData(
    '1f3b2',
    name: 'die',
    categories: ['Activities and events'],
    tags: [':die:'],
  ...
  static const slotMachine = AnimatedEmojiData(
    '1f3b0',
    name: 'slotMachine',
    categories: ['Activities and events'],
    tags: [':slot-machine:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa84/512.gif" alt="wand" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of wand.
  static const wand = AnimatedEmojiData(
    '1fa84',
    name: 'wand',
    categories: ['Activities and events'],
    tags: [':wand:'],
  ...
  static const cameraFlash = AnimatedEmojiData(
    '1f4f8',
    name: 'cameraFlash',
    categories: ['Activities and events'],
    tags: [':camera-flash:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fadf/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fadf/512.gif" alt="splatter" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of splatter.
  static const splatter = AnimatedEmojiData(
    '1fadf',
    name: 'splatter',
    categories: ['Activities and events'],
    tags: [':splatter:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3b7/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3b7/512.gif" alt="saxophone" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of saxophone.
  static const saxophone = AnimatedEmojiData(
    '1f3b7',
    name: 'saxophone',
    categories: ['Activities and events'],
    tags: [':saxophone:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3ba/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3ba/512.gif" alt="trumpet" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of trumpet.
  static const trumpet = AnimatedEmojiData(
    '1f3ba',
    name: 'trumpet',
    categories: ['Activities and events'],
    tags: [':trumpet:'],
  ...
  static const violin = AnimatedEmojiData(
    '1f3bb',
    name: 'violin',
    categories: ['Activities and events'],
    tags: [':violin:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa89/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa89/512.gif" alt="harp" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of harp.
  static const harp = AnimatedEmojiData(
    '1fa89',
    name: 'harp',
    categories: ['Activities and events'],
    tags: [':harp:'],
  ...
  static const drum = AnimatedEmojiData(
    '1f941',
    name: 'drum',
    categories: ['Activities and events'],
    tags: [':drum:'],
  ...
  static const maracas = AnimatedEmojiData(
    '1fa87',
    name: 'maracas',
    categories: ['Activities and events'],
    tags: [':maracas:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f3ac/512.gif" alt="clapper" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of clapper.
  static const clapper = AnimatedEmojiData(
    '1f3ac',
    name: 'clapper',
    categories: ['Activities and events'],
    tags: [':clapper:'],
  ...
  static const batteryFull = AnimatedEmojiData(
    '1f50b',
    name: 'batteryFull',
    categories: ['Objects'],
    tags: [':battery-full:'],
  ...
  static const batteryLow = AnimatedEmojiData(
    '1faab',
    name: 'batteryLow',
    categories: ['Objects'],
    tags: [':battery-low:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa99/512.gif" alt="coin" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of coin.
  static const coin = AnimatedEmojiData(
    '1fa99',
    name: 'coin',
    categories: ['Objects'],
    tags: [':coin:'],
  ...
  static const moneyWithWings = AnimatedEmojiData(
    '1f4b8',
    name: 'moneyWithWings',
    categories: ['Objects'],
  ...
  static const gemStone = AnimatedEmojiData(
    '1f48e',
    name: 'gemStone',
    categories: ['Objects'],
    tags: [':gem-stone:'],
  ...
  static const balanceScale = AnimatedEmojiData(
    '2696_fe0f',
    name: 'balanceScale',
    categories: ['Objects'],
    tags: [':balance-scale:'],
  ...
  static const lightBulb = AnimatedEmojiData(
    '1f4a1',
    name: 'lightBulb',
    categories: ['Objects'],
    tags: [':light-bulb:'],
  ...
  static const graduationCap = AnimatedEmojiData(
    '1f393',
    name: 'graduationCap',
    categories: ['Objects'],
    tags: [':graduation-cap:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1f48d/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f48d/512.gif" alt="ring" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of ring.
  static const ring = AnimatedEmojiData(
    '1f48d',
    name: 'ring',
    categories: ['Objects'],
    tags: [':ring:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/1faad/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faad/512.gif" alt="fan" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of fan.
  static const fan = AnimatedEmojiData(
    '1faad',
    name: 'fan',
    categories: ['Objects'],
    tags: [':fan:'],
  ...
  static const umbrella = AnimatedEmojiData(
    '2602_fe0f',
    name: 'umbrella',
    categories: ['Objects'],
    tags: [':umbrella:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1fa8f/512.gif" alt="shovel" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of shovel.
  static const shovel = AnimatedEmojiData(
    '1fa8f',
    name: 'shovel',
    categories: ['Objects'],
    tags: [':shovel:', ':dig:'],
  ...
  static const gear = AnimatedEmojiData(
    '2699_fe0f',
    name: 'gear',
    categories: ['Objects'],
    tags: [':gear:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26d3_fe0f_200d_1f4a5/512.gif" alt="brokenChain" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of brokenChain.
  static const brokenChain = AnimatedEmojiData(
  ...
  static const pencil = AnimatedEmojiData(
    '270f_fe0f',
    name: 'pencil',
    categories: ['Objects'],
    tags: [':pencil:'],
  ...
  static const alarmClock = AnimatedEmojiData(
    '23f0',
    name: 'alarmClock',
    categories: ['Objects'],
    tags: [':alarm-clock:'],
  ...
  static const bellhopBell = AnimatedEmojiData(
    '1f6ce_fe0f',
    name: 'bellhopBell',
    categories: ['Objects'],
    tags: [':bellhop-bell:'],
  ...
  static const bell = AnimatedEmojiData(
    '1f514',
    name: 'bell',
    categories: ['Objects'],
    tags: [':bell:'],
  ...
  static const crystalBall = AnimatedEmojiData(
    '1f52e',
    name: 'crystalBall',
    categories: ['Objects'],
    tags: [':crystal-ball:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f4a3/512.gif" alt="bomb" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of bomb.
  static const bomb = AnimatedEmojiData(
    '1f4a3',
    name: 'bomb',
    categories: ['Objects'],
    tags: [':bomb:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1faa4/512.gif" alt="mouseTrap" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of mouseTrap.
  static const mouseTrap = AnimatedEmojiData(
    '1faa4',
    name: 'mouseTrap',
    categories: ['Objects'],
    tags: [':mouse-trap:'],
  ...
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/1f512/512.gif" alt="locked" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of locked.
  static const locked = AnimatedEmojiData(
    '1f512',
    name: 'locked',
    categories: ['Objects'],
    tags: [':locked:'],
  ...
  static const aries = AnimatedEmojiData(
    '2648',
    name: 'aries',
    categories: ['Symbols'],
    tags: [':Aries:'],
  ...
  static const taurus = AnimatedEmojiData(
    '2649',
    name: 'taurus',
    categories: ['Symbols'],
    tags: [':Taurus:'],
  ...
  static const gemini = AnimatedEmojiData(
    '264a',
    name: 'gemini',
    categories: ['Symbols'],
    tags: [':Gemini:'],
  ...
  static const cancer = AnimatedEmojiData(
    '264b',
    name: 'cancer',
    categories: ['Symbols'],
    tags: [':Cancer:'],
  ...
  static const leo = AnimatedEmojiData(
    '264c',
    name: 'leo',
    categories: ['Symbols'],
    tags: [':Leo:'],
  ...
  static const virgo = AnimatedEmojiData(
    '264d',
    name: 'virgo',
    categories: ['Symbols'],
    tags: [':Virgo:'],
  ...
  static const libra = AnimatedEmojiData(
    '264e',
    name: 'libra',
    categories: ['Symbols'],
    tags: [':Libra:'],
  ...
  static const scorpio = AnimatedEmojiData(
    '264f',
    name: 'scorpio',
    categories: ['Symbols'],
    tags: [':Scorpio:'],
  ...
  static const sagittarius = AnimatedEmojiData(
    '2650',
    name: 'sagittarius',
    categories: ['Symbols'],
    tags: [':Sagittarius:'],
  ...
  static const capricorn = AnimatedEmojiData(
    '2651',
    name: 'capricorn',
    categories: ['Symbols'],
    tags: [':Capricorn:'],
  ...
  static const aquarius = AnimatedEmojiData(
    '2652',
    name: 'aquarius',
    categories: ['Symbols'],
    tags: [':Aquarius:'],
  ...
  static const pisces = AnimatedEmojiData(
    '2653',
    name: 'pisces',
    categories: ['Symbols'],
    tags: [':Pisces:'],
  ...
  static const ophiuchus = AnimatedEmojiData(
    '26ce',
    name: 'ophiuchus',
    categories: ['Symbols'],
    tags: [':Ophiuchus:'],
  ...
  static const exclamation = AnimatedEmojiData(
    '2757',
    name: 'exclamation',
    categories: ['Symbols'],
  ...
  static const question = AnimatedEmojiData(
    '2753',
    name: 'question',
    categories: ['Symbols'],
  ...
  static const exclamationQuestionMark = AnimatedEmojiData(
    '2049_fe0f',
  ...
  static const exclamationDouble = AnimatedEmojiData(
    '203c_fe0f',
    name: 'exclamationDouble',
    categories: ['Symbols'],
  ...
  static const crossMark = AnimatedEmojiData(
    '274c',
    name: 'crossMark',
    categories: ['Symbols'],
    tags: [':cross-mark:', ':x:'],
  ...
  static const sos = AnimatedEmojiData(
    '1f198',
    name: 'sos',
    categories: ['Symbols'],
    tags: [':sos:'],
  ...
  static const phoneOff = AnimatedEmojiData(
    '1f4f4',
    name: 'phoneOff',
    categories: ['Symbols'],
    tags: [':phone-off:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/2622_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/2622_fe0f/512.gif" alt="radioactive" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of radioactive.
  static const radioactive = AnimatedEmojiData(
    '2622_fe0f',
    name: 'radioactive',
    categories: ['Symbols'],
    tags: [':radioactive:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/2623_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/2623_fe0f/512.gif" alt="biohazard" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of biohazard.
  static const biohazard = AnimatedEmojiData(
    '2623_fe0f',
    name: 'biohazard',
    categories: ['Symbols'],
    tags: [':biohazard:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/26a0_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/26a0_fe0f/512.gif" alt="warning" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of warning.
  static const warning = AnimatedEmojiData(
    '26a0_fe0f',
    name: 'warning',
    categories: ['Symbols'],
    tags: [':warning:'],
  ...
  static const checkMark = AnimatedEmojiData(
    '2705',
    name: 'checkMark',
    categories: ['Symbols'],
  ...
  static const newSymbol = AnimatedEmojiData(
    '1f195',
    name: 'newSymbol',
    categories: ['Symbols'],
    tags: [':new:'],
  ...
  static const free = AnimatedEmojiData(
    '1f193',
    name: 'free',
    categories: ['Symbols'],
    tags: [':free:'],
  ...
  static const upSymbol = AnimatedEmojiData(
    '1f199',
    name: 'upSymbol',
    categories: ['Symbols'],
    tags: [':up!:'],
  ...
  static const cool = AnimatedEmojiData(
    '1f192',
    name: 'cool',
    categories: ['Symbols'],
    tags: [':cool:'],
  ...
  static const litter = AnimatedEmojiData(
    '1f6ae',
    name: 'litter',
    categories: ['Symbols'],
    tags: [':litter:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/262e_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/262e_fe0f/512.gif" alt="peaceSymbol" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of peaceSymbol.
  static const peaceSymbol = AnimatedEmojiData(
    '262e_fe0f',
    name: 'peaceSymbol',
    categories: ['Symbols'],
    tags: [':peace-symbol:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/262f_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/262f_fe0f/512.gif" alt="yinYang" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of yinYang.
  static const yinYang = AnimatedEmojiData(
    '262f_fe0f',
    name: 'yinYang',
    categories: ['Symbols'],
    tags: [':yin-yang:'],
  ...
  ///<picture>
  ///  <source srcset="https://fonts.gstatic.com/s/e/notoemoji/latest/267e_fe0f/512.webp" type="image/webp">
  ///  <img src="https://fonts.gstatic.com/s/e/notoemoji/latest/267e_fe0f/512.gif" alt="infinity" width="32" height="32">
  ///</picture>
  ///
  /// Animated emoji of infinity.
  static const infinity = AnimatedEmojiData(
    '267e_fe0f',
    name: 'infinity',
    categories: ['Symbols'],
    tags: [':infinity:'],
  ...
  static const musicalNotes = AnimatedEmojiData(
    '1f3b6',
    name: 'musicalNotes',
    categories: ['Symbols'],
    tags: [':musical-notes:'],
  ...
  static const plusSign = AnimatedEmojiData(
    '2795',
    name: 'plusSign',
    categories: ['Symbols'],
    tags: [':plus-sign:', ':+:'],
  ...
  static const chequeredFlag = AnimatedEmojiData(
    '1f3c1',
    name: 'chequeredFlag',
    categories: ['Flags'],
    tags: [':chequered-flag:'],
  ...
  static const triangularFlag = AnimatedEmojiData(
    '1f6a9',
    name: 'triangularFlag',
    categories: ['Flags'],
  ...
  static const blackFlag = AnimatedEmojiData(
    '1f3f4',
    name: 'blackFlag',
    categories: ['Flags'],
    tags: [':black-flag:'],
  ...
  static const whiteFlag = AnimatedEmojiData(
    '1f3f3_fe0f',
    name: 'whiteFlag',
    categories: ['Flags'],
    tags: [':white-flag:'],
